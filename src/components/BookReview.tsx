...
const BookReview = ({ bookId, refetchReviews }: Props) => {
    const [b64, setB64] = useState<string>()
    const { register, handleSubmit } = useForm<MakeReviewType>()
    ...
    const onSubmit: SubmitHandler<MakeReviewType> = (data) => {
        createReviewMutate({ ...data, bookId })
    }
